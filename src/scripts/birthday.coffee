...
#
# Commands:
#   hubot birthday quote -- random birthday quote
#   hubot celebrate me <user> -- congratulate <user> with an more inspirational greeting 
#   hubot happy birthday me <user> -- congratulate <user>
#
# Author:
#   sopel
...
greetings = [
  ...
  "{name} - Growing old is mandatory; growing up is optional.",
